...
export const recommendationsData = {
  ...
  'other': [
    { id: 132, date: '12/09/2024', sender: '~ Yaelyon', message: 'למישהי יש המלצה לבית דפוס לכמות קטנה של דברים, באזור תל אביב?' },
    { id: 133, date: '30/01/2025', sender: '~ Hagar Klein Peleg', message: 'למישהי יש המלצה על נהג הסעות?' },
    { id: 134, date: '03/03/2025', sender: '~ שרון חדד שלפר', message: 'היי, אשמח להמלצה על חברת הסעות בצפון לצורך שינוע חיילים' },
    { id: 135, date: '18/03/2025', sender: '~ Limor Sherman', message: 'האם אתן עושות עמדת זכרון ביום השואה? אשמח לרעיונות / המלצות לספק' },
    { id: 136, date: '13/03/2025', sender: '~ Rotem Haim', message: 'המלצה מאיפה להזמין אוזני המן ללא גלוטן + טבעוני ליום שני? ‎<This message was edited>' }
  ]
};